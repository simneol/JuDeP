	...
	: QMainWindow(parent)
{
	...
	connect(this,SIGNAL(slotLoginSignal(QString,QString,bool)),&loginManager,SLOT(slotLogin(QString,QString,bool)));
...
void LoginWindow::slotEmitLoginSignal(){emit slotLoginSignal(ui.lineEdit_Id->text(),ui.lineEdit_Pw->text(),ui.radio_User->isChecked());}