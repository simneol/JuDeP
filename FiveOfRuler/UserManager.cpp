...
// 용도 : 유저 매니저의 값을 해제하고 끝날 때 적절한 처리를 하는 소멸자이다.
UserManager::~UserManager(){qDebug("~UserManager");}

// 용도 : 자신의 값을 반환하는 포인터형 메서드이다.
User* UserManager::getUser(){return user;}

// 용도 : 로그아웃의 화면을 보여주는 메서드이다.
...
// 용도 : Qna의 값을 읽어들이는 창을 불러주는 메서드이다.
